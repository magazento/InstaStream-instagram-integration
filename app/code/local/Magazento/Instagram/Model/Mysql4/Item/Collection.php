...
class Magazento_Instagram_Model_Mysql4_Item_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract {
    ...
    public function addStoreFilter($store, $withAdmin = true) {
        ...
        $this->getSelect()->join(
                        array('item_store' => $this->getTable('instagram/item_store')),
    ...
    public function addCategoryFilter($category) {
        ...
        $this->getSelect()->joinleft(
                        array('item_category' => $this->getTable('instagram/item_category')),
    ...
    public function addProductFilter($product) {
        ...
        $this->getSelect()->joinleft(
                        array('item_product' => $this->getTable('instagram/item_product')),
    ...
    public function addPageFilter($page) {
        $this->getSelect()->joinleft(
                    array('item_page' => $this->getTable('instagram/item_page')),
