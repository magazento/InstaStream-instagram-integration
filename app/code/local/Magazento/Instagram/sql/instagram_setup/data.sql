...
--
-- Host: localhost
-- Generation Time: Dec 16, 2012 at 01:51 PM
...
--
-- Table structure for table `magazento_instagram_item`
--

CREATE TABLE IF NOT EXISTS `magazento_instagram_item` (
...
--
-- Table structure for table `magazento_instagram_item_category`
--

CREATE TABLE IF NOT EXISTS `magazento_instagram_item_category` (
  `item_id` smallint(6) unsigned DEFAULT NULL,
  `category_id` smallint(6) unsigned DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `magazento_instagram_item_category`
--

INSERT INTO `magazento_instagram_item_category` (`item_id`, `category_id`) VALUES
(48, 19),
(53, 10),
(53, 13),
(53, 18);
...
--
-- Table structure for table `magazento_instagram_item_page`
--

CREATE TABLE IF NOT EXISTS `magazento_instagram_item_page` (
  `item_id` smallint(6) unsigned DEFAULT NULL,
  `page_id` smallint(6) unsigned DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `magazento_instagram_item_page`
--

INSERT INTO `magazento_instagram_item_page` (`item_id`, `page_id`) VALUES
(55, 3),
(48, 2),
(48, 3),
(48, 5),
...
--
-- Table structure for table `magazento_instagram_item_product`
--

CREATE TABLE IF NOT EXISTS `magazento_instagram_item_product` (
  `item_id` smallint(6) unsigned DEFAULT NULL,
  `product_id` smallint(6) unsigned DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `magazento_instagram_item_product`
--

INSERT INTO `magazento_instagram_item_product` (`item_id`, `product_id`) VALUES
(48, 39);

-- --------------------------------------------------------

--
-- Table structure for table `magazento_instagram_item_store`
--

CREATE TABLE IF NOT EXISTS `magazento_instagram_item_store` (
  `item_id` smallint(6) unsigned DEFAULT NULL,
  `store_id` smallint(6) unsigned DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `magazento_instagram_item_store`
--

INSERT INTO `magazento_instagram_item_store` (`item_id`, `store_id`) VALUES
(55, 0),
(48, 0),
(52, 0),
(53, 0),
