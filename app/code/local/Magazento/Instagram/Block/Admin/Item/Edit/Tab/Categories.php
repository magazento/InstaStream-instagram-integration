...
class Magazento_Instagram_Block_Admin_Item_Edit_Tab_Categories extends Mage_Adminhtml_Block_Catalog_Category_Tree
{
    ...
    {
        parent::__construct();
        $this->setTemplate('magazento_instagram/cattree.phtml');
    }
